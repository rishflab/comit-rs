...
async fn initiate_request<AL, BL, AA, BA, AI, BI, AH, BH>(
    dependencies: Facade,
    id: SwapId,
        ...
        + HtlcRefunded<BL, BA, BI>,
{
    ...
    let state = alice::State::<_, _, _, _, _, _, AH, BH>::proposed(swap_request.clone(), seed);
        ...
        async move {
            ...
            match response {
                ...
                Err(decline) => {
                    ...
                    let state = alice::State::<_, _, _, _, _, _, AH, BH>::declined(
                        swap_request.clone(),
                        decline,
                        seed,
                    );
...
pub async fn handle_post_swap(
    ...
    match body {
        SwapRequestBody {
            ...
            initiate_request::<_, _, _, _, _, _, bitcoin::OutPoint, identity::Ethereum>(
                dependencies,
                id,
                peer,
                request,
        ...
        SwapRequestBody {
            ...
            beta_ledger: HttpLedger::BitcoinMainnet,
            ...
            initiate_request::<_, _, _, _, _, _, identity::Ethereum, bitcoin::OutPoint>(
                dependencies,
                id,
                peer,
                request,
        ...
        SwapRequestBody {
            alpha_ledger: HttpLedger::Ethereum(alpha_ledger),
            beta_ledger: HttpLedger::BitcoinTestnet,
            alpha_asset: HttpAsset::Ether(alpha_asset),
            beta_asset: HttpAsset::Bitcoin(beta_asset),
            alpha_expiry,
            beta_expiry,
